...
<option value = "Yadavrao Tasgaonkar Institute of Engineering & Technology�(YTIET),�Bhivpuri">
    ...
    <div class="formGroup"> 
      ...
      <input id="startDate"  class="form-control" type="date" value="<?php echo $row['sdate'];?>" required ata-date="" name="Date_From" data-date-format="DD/MM/YYYY" placeholder="DD/MM/YYYY" onchange="cal()">
    </div>
    <div class="formGroup"> 
...
<div class="formGroup"> 
  ...
  <div id="Amt">
    <input type="number"  class="form-control" required name="TA1" value="<?php echo $row['criteria'];?>" placeholder="enter the amount">
  </div>
</div>
  <script type="text/javascript">
