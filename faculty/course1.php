    ...
    <div>
      ...
      Courses
        ...
        <div class="formGroup">
          ...
          <input list="all-collage" class="form-control" required id="venue" name="Venue" onchange="changevenue()">
          <!-- data list of id all-collage is placed and end of body  -->
          </div>
          <div class="formGroup">
        ...
        <div class="formGroup">
          ...
          <div class="formGroup" style="margin-left: 19rem;">
